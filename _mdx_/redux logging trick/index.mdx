...
While redux is far from being the coolest kid in the playground at the moment (late 2020), I am still using it on some of my projects. There is still one feature, which most of its competitors (like recoil, zustand, jotai, react-query or SWR) lack so far: mature and feature rich devtools.

But even on redux-devtools, there was something which makes me think meh… and that thing is logging constants. Even though I made my redux constants (thanks mostly ducks inspiration) much less GENERATED_CODE_LIKE and more human readable, I'd like to have a possibility to use parametrize them.
