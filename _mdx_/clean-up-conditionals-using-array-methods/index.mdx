...
I think we've all been there at some moment of our coding paths. We have simple `if` statement with a condition – all nice and tidy. But it soon turned out that there's another condition that needs to be checked. We have _two_ conditions now.
