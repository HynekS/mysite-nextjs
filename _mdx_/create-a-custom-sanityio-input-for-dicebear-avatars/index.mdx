...
slug: create-a-custom-sanityio-input-for-dicebear-avatars
author: Hynek Svacha
type:
dateCreated: Apr 2, 2020 21:20
dateLastModified:
...
![Animated gif of finished avatar input](assets/avatar-input-animation.gif)

## Conclusion

There are still things that should probably be added, e. g.:

- propsTypes definitions,
...
But I sense that the resulting code has an rather scary length already, so I'll just left it that way. Feel free to extend it further if you'd like to.
